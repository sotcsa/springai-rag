...
- **🔢 Lokális embedding**: Ollama `bge-m3` modell (1024 dimenzió)
...
# Modellek letöltése
ollama pull bge-m3               # Embedding modell (1024 dim)
...
| `spring.ai.ollama.embedding.options.model` | `bge-m3` | Embedding modell |
